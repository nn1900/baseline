...
var yargs = require('yargs')
  ...
  .command('restore', 'restore the specified configured database')
  ...
  .options({
    ...
    'input': {
      alias: 'i',
      describe: 'input backup file used for database restore'
    },
    'drop-database': {
      type: 'boolean',
      describe: 'drop database before restore'
    }
  })
...
module.exports = {
  ...
  input: argv.input,
  dropDatabase: argv.dropDatabase,
  yargs
};
